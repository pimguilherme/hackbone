define(function (require) {
    ...
    var error = Utils.scopedError('Collection')
    ...
    Collection.prototype = {
        ...
        fetch:function (options) {
            ...
            return (this._sync = Hackbone.APITransport.sync('read', this, options)
        ...
        _prepareModel:function (model, options) {
            if (!(model instanceof Hackbone.Model)) {
                var attrs = model;
                model = Hackbone.Model.create(this.model.prototype.name, attrs, options);
...
//            if (!props.name) error('You must supply a name when extending a Collection', props, statics);
    ...
    Collection.getModel = function (name) {
        if (!cols[name]) error("Invalid collection", name)
