define(
    ['Collection',
        'lib/Backbone/Utils',
        'lib/Backbone/Events',
        'lib/Backbone/ModelChangeMap',
        'lib/Backbone/ModelRegistry',
        'lib/Backbone/APITransport',
        'lib/Backbone/HashSanidator',
        'underscore', 'config', 'api-config', 'lib/utils'],
    function (
        Collection, Utils, Events, ModelChangeMap, Registry, Transport, HashSanidator, _, config, apiConfig, utils
        ) {


        var error = utils.scopedError('ModelError')
        ...
        Model.prototype = {
            ...
            toJSON:function () {
                ...
                for (var name in this.attributes) {
                    if (name[0] == '-') continue;
                    attrs[name] = this.attributes[name] instanceof Model ? (this.attributes[name].id || undefined) : this.attributes[name];
                }
                return attrs;
            },
            ...
            fetch:function (options) {
                var self = this;
                return Transport.sync('read', this, options)
            ...
            save:function (key, value, options) {
                ...
                return Transport.sync(method, this, options)
            ...
            destroy:function (options) {
                ...
                var sync = Transport.sync('delete', this, options)
        ...
        Model.create = function (modelName, values, options) {
            ...
            if (values && values['_id'] && (model = Registry.fetch(modelName, values['_id']))) {
                model.set(values);
                return model;
            }
        ...
        ModelChangeMap(Model, Collection);
